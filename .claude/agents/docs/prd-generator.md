...
- 상세한 기술 스택과 용도별 분류
- **반드시 최신 버전 명시**: Next.js 16, React 19.2 등
...
- **Next.js 16** (App Router) - React 풀스택 프레임워크 (View Transitions 자동 지원, proxy.ts)
- **TypeScript 5.6+** - 타입 안전성 보장
- **React 19.2** - UI 라이브러리 (View Transitions, useEffectEvent, Activity)
...
6. **최신 기술**: **반드시 현재 최신 버전** 명시 (Next.js 16, React 19.2 등)

## 🔧 기술 스택 선택 원칙

- **최신 버전 필수**: Next.js 16, React 19.2, TailwindCSS v4 등 최신 버전 사용
- **Next.js 16 기반**: 최신 App Router, View Transitions 자동 지원, React 19.2 통합
